      ...
      return(
        <div style={instructionStyle}>
          ...
          <ul>
            ...
            <li><b>Step 3- Ground your general logical rules to the story:</b> You should ground your generic rules from previous step to the story in order to make them specific. You will do this by linking parts of your logical rules to the phrases in either the context or the given ending of the story.
			</li>            
