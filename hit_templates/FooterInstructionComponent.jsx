    ...
    if(nextProps.step == 0) {
      ...
      instructions.push('Given the above endings, choose an ending that fits the story best.');
        ...
        if(nextProps.substep == 1) {
          instructions.push('READ the story and provided ending.');
          instructions.push('SELECT a subject placeholder from the dropdown list (premise).');
          instructions.push('SELECT an object placeholder from the dropdown list (premise).');
          ...
          instructions.push('SELECT a subject placeholder from the dropdown list (consequence).');
          instructions.push('SELECT an object placeholder from the dropdown list (consequence).');
          instructions.push('TYPE a predicate (consequence) - how does the subject interact with the object?');
