  ...
  render: function() {
    ...
    if(this.props.index == this.props.i_x) {
      return(
        ...
        <button onClick={this.save} className='btn btn-xs step-fwd-btn' style={inlineBlock}>(~)Save Rule</button>
        <button onClick={this.save} className='btn btn-xs step-bkwd-btn' style={inlineBlock}>(~)Save Rule</button>
        {
